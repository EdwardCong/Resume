...
\position{Computer Engineer{\enskip\cdotp\enskip}Persistent Learner{\enskip\cdotp\enskip}Enthusiastic Developer} % Your expertise/fields

\makecvfooter{\today}{Edward Cong~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
